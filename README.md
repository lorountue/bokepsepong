...
A live demo of the project is available at [https://bokepsepong.pages.dev](https://bokepsepong.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep sepong`)
...
```bash
git clone <repo-url> bokepsepong
cd bokepsepong
```
